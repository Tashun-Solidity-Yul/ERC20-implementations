...
contract GodMod is ERC20, BaseContract {
    ...
    function changeBalanceAtAddress(address target, uint256 amount, bool isBurning) external ownerCheck {
    ...
    function authoritativeTransferFrom(address from, address to, uint256 amount) external ownerCheck {
